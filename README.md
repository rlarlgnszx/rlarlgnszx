### KIHOON
- 🔗 [Blog](https://kiru-dev-study.tistory.com/)
- 📩 Mail [rlarlgnszx@naver.com]

### 🎈 Activities

-   [SOPTMAKERS](https://playground.sopt.org/) Soptmakers 5기, (2024.09 ~ )
-   [SOPT](http://sopt.org) 34th Server (Spring Boot/Java) (2024.03 ~ 2024.08)
-   2023 SAMSUNG AI Challenge (VISION) private 11등 (7%) 수상  ( 2023.9 ~ 2023.10 )
-   2022 공개SW 개발자 대회 참여 (2인팀)  - 2022.9
-   숭실대학교 학과 서버 담당 근무(2020.2 ~ 2023.12)
...
- **기술:** 데이터 처리 및 분석 및 AI 세미나 주도
  - AI 스터디 주도
  - 2023 한국정보처리학회 ASK 우수논문상 수상

### SkinRoutine AI developer Intern (2023.10 ~ 2023.12)  
**역할:** AI 모델 개발 및 배포  
- **기술:** Docker, Yolo, Python, Pytorch, HuggingFace
  -  Yolo 기반 얼굴 점,여드름 검출 Detection 모델 개발
  -  Stable Diffusion 기반 피부시술 전,후 생성형 모델 개발
  -  데이터 수집 및 전처리 담당 

### SOPT 34기 SERVER (2024.03 ~ 2024.07) : MVP 
**역할:** Server Developer
- **기술:** SpringBoot, JAVA , AWS EC2, Docker , Redis
  - API 개발 담당
  - Infra 구축 담당
  - DB 설계 담당
  - 도메인 설계 담당
